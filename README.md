...
| <a name="input_enable_encryption"></a> [enable\_encryption](#input\_enable\_encryption) | Set to true to enable encryption of logs and sqs messages. Requires kms\_key\_arn to be set. | `bool` | `false` | no |
