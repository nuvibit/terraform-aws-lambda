...
| <a name="input_encryption"></a> [encryption](#input\_encryption) | Manages the encryption of the Lambda Debug CloudWatch LogGroup and the optional SQS.<br>If this variable is False (default) and kms\_key\_arn == null (default), no encryption will be applied.<br>If this variable is True and kms\_key\_arn == null, a new KMS CMK will be created.<br>If this variable is True and kms\_key\_arn != null, the provided KMS CMK will be used and the key policy will be extended.<br>If this variable is False and kms\_key\_arn != null, the provided KMS CMK will be used and the key policy will be extended. | `bool` | `false` | no |
