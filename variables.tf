...
variable "layers" {
  ...
  validation {
    ...
    error_message = "The List must contain ARNs of maximum 5 lambda-layers, starting with 'arn:aws:lambda'."
  }
}
...
variable "package_type" {
  ...
  validation {
    ...
    error_message = "Valid values are Zip."
  }
}
...
variable "memory_size" {
  ...
  validation {
    ...
    error_message = "Enter a value between 128 MB and 10240 MB in 1-MB increments."
  }
}
...
variable "timeout" {
  ...
  validation {
    ...
    error_message = "The maximum allowed value is 900 seconds."
  }
}
...
variable "file_system_config_arn" {
  ...
  validation {
    ...
    error_message = "Value must contain Amazon EFS Access Point ARN, starting with 'arn:aws:elasticfilesystem'."
  }
}
...
variable "reserved_concurrent_executions" {
  ...
  validation {
    ...
    error_message = "The value must be -1 or bigger."
  }
}
...
variable "iam_execution_policy_arns" {
  ...
  validation {
    ...
    error_message = "Values must contain AWS IAM Policy ARNs, starting with 'arn:aws:iam'."
  }
}
...
All previously ingested data remains encrypted, and AWS CloudWatch Logs requires permissions for the CMK whenever the encrypted data is requested.
  ...
  validation {
    ...
    error_message = "KMS key id must contain ARN, starting with \"arn:aws:kms\"."
  }
}
...
variable "schedule_expression" {
  ...
  validation {
    ...
    error_message = "Schedule is not a valid CRON expression."
  }
}
